...
// 导入你创建的任务文件 (根据你重命名的文件名更新路径)
require("./tasks/lockIma.js"); 
...
module.exports = {
  ...
  networks: {
    ...
    imua: {
      ...
      accounts: [process.env.IMUA_PRIVATE_KEY], // 部署LockTokens合约的账户
    ...
    sepolia: {
      ...
      accounts: [
        process.env.PRIVATE_KEY,        // 部署Token合约的账户 (拥有 DEFAULT_ADMIN_ROLE)
        process.env.PRIVATE_KEY_ADDR1,   // 手动操作员账户 (用于在B链上铸币, 需拥有 MINTER_ROLE)
      ].filter(Boolean),
